...
export default function Hero() {
  ...
  return (
    <section className="pt-16 pb-14 flex flex-col items-start gap-6">
      <div className="flex items-center gap-2.5 font-mono text-xs tracking-[0.14em] uppercase text-cyan">
        <span className="w-2 h-2 rounded-full bg-cyan shadow-[0_0_10px_#4fd1e8] inline-block" />
        {t.hero.eyebrow}
      </div>
      ...
      <div className="flex flex-wrap gap-3 pt-1">
        <a
          href="#projects"
          className="px-6 py-3 rounded-full font-semibold text-[14px] text-[#0a0e1f] bg-gradient-to-r from-violet to-cyan no-underline transition-transform hover:-translate-y-0.5"
        >
          {t.hero.ctaProjects}
        </a>
